...
class Video extends \yii\base\Model
{
    ...
    private function calcTotalCount(): int
    {
        ...
        // Если это не так - необходимо придумывать другой механизм. Как вариант - вернуться к стандартному
        // запросу типа select count(*) ..., добавить кэширование его результата
        $sql = <<<SQL
SELECT MAX(id)
